package cn.bugstack.middleware.dynamic.thread.pool.sdk.trigger.listenter;
...
public class ThreadPoolConfigAdjustListener implements MessageListener<ThreadPoolConfigEntity> {
    ...
    public void onMessage(CharSequence charSequence, ThreadPoolConfigEntity threadPoolConfigEntity) {
        ...
        dynamicThreadPoolService.updateThreadPoolConfig(threadPoolConfigEntity);//变更线程池数据
        //更新后上报最新数据
        List<ThreadPoolConfigEntity> threadPoolConfigEntities = dynamicThreadPoolService.queryThreadPoolList();
        registry.reportThreadPool(threadPoolConfigEntities);//上报数据
